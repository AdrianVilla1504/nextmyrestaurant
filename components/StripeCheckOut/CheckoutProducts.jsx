...
const CheckoutProducts = ({ product, handleRemoveItem }) =>
{
  ...
  return (
    <div>
      {product ? (
        <li key={product._id} className="flex flex-row py-6">
          ...
          <div className="flex flex-col">
            <div className="ml-4 flex flex-1 flex-col">
              ...
              <div className="flex pt-[10px] pr-[5px] flex-1 flex-col lg:flex-row lg:flex-1 items-end justify-between text-sm">
                <p className="text-black pr-[10px] pb-[5px] ml-4">
                  X
                </p>
                <input
                  className="h-[30px] lg:w-[40px] lg:pr-[0px] lg:text-center border-black-500"
                  min="1"
                  key={product._id}
                  type="number"
                  id="qty"
                ...
                />
                <p className="ml-4 text-black lg:pl-[0px] lg:pb-[5px]">$ {product.price*product.qty} USD</p>
                <div className="flex">
                  <button
                    type="button"
